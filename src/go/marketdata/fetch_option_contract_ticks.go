...
func FetchOptionContractTicks(url, bearerToken string, symbol models.StockSymbol, expiration string) ([]*models.OptionChainTickDTO, error) {
	client := http.Client{
	...
	var dto models.OptionContractChainDTO
