...
type OptionOrderSpreadResult struct {
	...
	UnderlyingPriceAtOpen           float64      `json:"underlying_price_at_open" csv:"underlying_price_at_open"`
	UnderlyingPriceAtExpiry         float64      `json:"underlying_price_at_expiry" csv:"underlying_price_at_expiry"`
	...
	StartsAtConfig                  string       `json:"starts_at_config" csv:"starts_at_config"`
	EndsAtConfig                    string       `json:"ends_at_config" csv:"ends_at_config"`
	ExpirationsInDaysConfig         []int        `json:"expirations_in_days_config" csv:"expirations_in_days_config"`
	MinDistanceBetweenStrikesConfig float64      `json:"min_distance_between_strikes_config" csv:"min_distance_between_strikes_config"`
	MaxNoOfStrikesConfig            int          `json:"max_no_of_strikes_config" csv:"max_no_of_strikes_config"`
}
