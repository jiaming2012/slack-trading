...
func Run_Supertrend1hStochRsi15mUp(args eventmodels.SupertrendRunArgs) (eventmodels.SignalRunOutput, error) {
	...
	outDir := path.Join(projectDir, "src", "cmd", "stats", "transform_data", "supertrend_1h_stoch_rsi_15m_up", "output")
