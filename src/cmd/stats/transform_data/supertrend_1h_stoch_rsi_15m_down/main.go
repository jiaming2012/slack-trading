...
import (
	...
	"github.com/jiaming2012/slack-trading/src/cmd/stats/transform_data/supertrend_1h_stoch_rsi_15m_down/run"
)

var rootCmd = &cobra.Command{
	Use:   "main",
	Short: "Generates the supertrend_1h_stoch_rsi_15m_down signal",
	Long: `This program creates a multi-timeframe signal using the following indicators:
1.) The 1h supertrend indicators
