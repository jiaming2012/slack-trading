...
if __name__ == "__main__":
    ...
    repos = SimpleStackOpenStrategyV2.get_repositories(symbol, datetime.fromisoformat(start_date), datetime.fromisoformat(end_date))
    ...
    max_open_count = 3
    strategy = SimpleStackOpenStrategyV2(playground, max_open_count, additional_profit_risk_percentage, updateFrequency, symbol, logger)
