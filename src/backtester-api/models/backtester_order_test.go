...
func TestBacktesterOrderStatus(t *testing.T) {
	...
	t.Run("Open", func(t *testing.T) {
		order := NewBacktesterOrder(1, BacktesterOrderClassEquity, now, eventmodels.StockSymbol("AAPL"), "buy", 10, Market, Day, 0.01, nil, nil, BacktesterOrderStatusPending, "")
	...
	t.Run("Filled - quantity exceeds order quantity", func(t *testing.T) {
		quantity := 10.0
		order := NewBacktesterOrder(1, BacktesterOrderClassEquity, now, eventmodels.StockSymbol("AAPL"), "buy", quantity, Market, Day, 0.01, nil, nil, BacktesterOrderStatusPending, "")
