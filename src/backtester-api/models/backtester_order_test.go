...
func TestOrderRecordStatus(t *testing.T) {
	...
	t.Run("New", func(t *testing.T) {
		order, err := NewOrderRecord(1, nil, nil, uuid.Nil, OrderRecordClassEquity, LiveAccountTypeMock, now, "AAPL", "buy", 10, Market, Day, 0.01, nil, nil, OrderRecordStatusPending, "", nil)
	...
	t.Run("Filled - quantity exceeds order quantity", func(t *testing.T) {
		quantity := 10.0
		order, err := NewOrderRecord(1, nil, nil, uuid.Nil, OrderRecordClassEquity, LiveAccountTypeMock, now, "AAPL", "buy", quantity, Market, Day, 0.01, nil, nil, OrderRecordStatusPending, "", nil)
		require.NoError(t, err)
