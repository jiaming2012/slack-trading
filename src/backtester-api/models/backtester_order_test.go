...
func TestOrderRecordStatus(t *testing.T) {
	...
	t.Run("Open", func(t *testing.T) {
		order := NewOrderRecord(1, nil, uuid.Nil, OrderRecordClassEquity, LiveAccountTypeMock, now, eventmodels.StockSymbol("AAPL"), "buy", 10, Market, Day, 0.01, nil, nil, OrderRecordStatusPending, "", nil)
	...
	t.Run("Filled - quantity exceeds order quantity", func(t *testing.T) {
		quantity := 10.0
		order := NewOrderRecord(1, nil, uuid.Nil, OrderRecordClassEquity, LiveAccountTypeMock, now, eventmodels.StockSymbol("AAPL"), "buy", quantity, Market, Day, 0.01, nil, nil, OrderRecordStatusPending, "", nil)
