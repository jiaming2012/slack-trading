...
func (s *Strategy) UpdateExitConditions(newSignal *CreateSignalRequestEventV1) int {
...
func (s *Strategy) UpdateEntryConditions(newSignal *CreateSignalRequestEventV1) int {
	conditionsAffected := 0
