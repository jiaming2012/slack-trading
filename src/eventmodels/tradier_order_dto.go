...
func (dto *TradierOrderDTO) ToTradierOrder() (*TradierOrder, error) {
	...
	return &TradierOrder{
		...
		Symbol:                    dto.Symbol,
		Side:                      dto.Side,
		AbsoluteQuantity:          dto.Quantity,
		Status:                    dto.Status,
		Duration:                  dto.Duration,
		Price:                     dto.Price,
		AvgFillPrice:              dto.AvgFillPrice,
		AbsoluteExecQuantity:      dto.ExecQuantity,
		LastFillPrice:             dto.LastFillPrice,
		AbsoluteLastFillQuantity:  dto.LastFillQuantity,
		AbsoluteRemainingQuantity: dto.RemainingQuantity,
