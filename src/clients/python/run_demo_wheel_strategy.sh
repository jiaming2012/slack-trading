#!/usr/bin/env bash
# Run the wheel strategy demo using the grodt conda environment.
# Usage: ./run_demo_wheel_strategy.sh [--symbol AAPL] [--start 2024-06-01] [--end 2024-12-31] ...
#
# All arguments are forwarded to demo_wheel_strategy.py.
...
cd "$SCRIPT_DIR"
exec "$PYTHON" demo_wheel_strategy.py "$@"
