...
def make_retrain_callback(
    ...
    """Create a callback for ``run_mean_reversion(on_tick=...)``."""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "Examples:\n"
            "  # Static PDF:\n"
            "  python demo_mean_reversion.py --pdf-path aapl_5m_1h_pdf.json\n"
            "\n"
            "  # Weekly retrain:\n"
            "  python demo_mean_reversion.py --retrain-interval weekly\n"
        ),
    )
