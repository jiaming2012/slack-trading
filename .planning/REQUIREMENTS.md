...
- [x] **LABEL-03**: Signals Generated panel filterable by signal_type name
- [x] **LABEL-04**: Candles Processed panel filterable by candle symbol

## Panel Improvements

- [x] **PANEL-01**: Active Playgrounds lists client_id/playground_id instead of a count
- [x] **PANEL-02**: Python Strategy Heartbeat shows per-playground status, not binary alive/dead
