module.exports = {
  apps : [{
    ...
    env_paper: {
      PLAYGROUND_CLIENT_ID: 'supertrend1-aapl-paper-9',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'paper',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    env_production : {
      PLAYGROUND_CLIENT_ID: 'supertrend1-aapl-margin-9',
      PLAYGROUND_ENV: 'live',
    ...
    env_paper: {
      PLAYGROUND_CLIENT_ID: 'supertrend1-coin-paper-9',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'paper',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    env_production : {
      PLAYGROUND_CLIENT_ID: 'supertrend1-coin-margin-9',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'margin',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    ...
    env_production : {
      PLAYGROUND_CLIENT_ID: 'supertrend1-meta-margin-9',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'margin',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    ...
    env_paper: {
      PLAYGROUND_CLIENT_ID: 'supertrend1-nvda-paper-9',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'paper',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    env_production : {
      PLAYGROUND_CLIENT_ID: 'supertrend1-nvda-margin-9',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'margin',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    ...
    env_paper: {
      PLAYGROUND_CLIENT_ID: 'supertrend1-tsla-paper-9',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'paper',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    env_production : {
      PLAYGROUND_CLIENT_ID: 'supertrend1-tsla-margin-9',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'margin',
      TWIRP_HOST: 'http://45.77.223.21',
    },
