module.exports = {
  apps : [{
    ...
    env_paper: {
      PLAYGROUND_CLIENT_ID: 'supertrend1-aapl-paper-10',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'paper',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    env_production : {
      PLAYGROUND_CLIENT_ID: 'supertrend1-aapl-margin-10',
      PLAYGROUND_ENV: 'live',
    ...
    env_paper: {
      PLAYGROUND_CLIENT_ID: 'supertrend1-coin-paper-10',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'paper',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    env_production : {
      PLAYGROUND_CLIENT_ID: 'supertrend1-coin-margin-10',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'margin',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    ...
    env_paper: {
      PLAYGROUND_CLIENT_ID: 'supertrend1-meta-paper-10',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'paper',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    env_production : {
      PLAYGROUND_CLIENT_ID: 'supertrend1-meta-margin-10',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'margin',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    ...
    env_paper: {
      PLAYGROUND_CLIENT_ID: 'supertrend1-nvda-paper-10',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'paper',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    env_production : {
      PLAYGROUND_CLIENT_ID: 'supertrend1-nvda-margin-10',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'margin',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    ...
    env_paper: {
      PLAYGROUND_CLIENT_ID: 'supertrend1-tsla-paper-10',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'paper',
      TWIRP_HOST: 'http://45.77.223.21',
    },
    env_production : {
      PLAYGROUND_CLIENT_ID: 'supertrend1-tsla-margin-10',
      PLAYGROUND_ENV: 'live',
      LIVE_ACCOUNT_TYPE: 'margin',
      TWIRP_HOST: 'http://45.77.223.21',
    },
