...
env = PlaygroundEnvironment(args.symbol, args.start_date, args.end_date, initial_balance=10000, mode=PlaygroundEnvironmentMode.Validate, repository_source=RepositorySource.POLYGON)
